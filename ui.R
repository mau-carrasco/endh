...
header.append('<div style=\"float:right\"><a href=\"https://www.indh.cl\"><img src=\"logo.png\" alt=\"alt\" style=\"float:right;height:41px;padding-top:10px;\"> </a></div>');
    ...
    tabPanel("Datos",
             ...
             fluidRow(
                 ...
                 column(6,
                        h5(strong("Cuarta Encuesta Nacional de Derechos Humanos - 2018: ")),
                        strong("Base de datos: "),
             ...
             fluidRow(
                 column(6,
                        h5(strong("Tercera Encuesta Nacional de Derechos Humanos - 2015: ")),
                        strong("Base de datos: "),
                        p(downloadLink("download2015_sav", "SPSS"), " | ", downloadLink("download2015_dta", "STATA"), " | ", downloadLink("download2015_rds", "R")),
                        strong("Documentos: "),
                        p(downloadLink("cuestionario2015", "Cuestionario"), "|", downloadLink("informe2015", "Informe"), " | ", downloadLink("codigos2015", "Libro de códigos")),
                        ),
                 column(6,
                        h5(strong("Segunda Encuesta Nacional de Derechos Humanos - 2013: ")),
                        strong("Base de datos: "),
                        p(downloadLink("download2013_sav", "SPSS"), " | ", downloadLink("download2013_dta", "STATA"), " | ", downloadLink("download2013_rds", "R")),
                        strong("Documentos: "),
